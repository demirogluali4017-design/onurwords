...
1. "preposition" alanı: Kelimenin (özellikle fiillerin/sıfatların) görselde geçen TÜM edat kalıplarını EKSİKSİZ ve BİREBİR yaz.
   - Görselde "sth" (something) veya "sb" (somebody) gibi kısaltmalar varsa bunları da kalıba dahil et, çıkarma. Örnek: "depend on sb/sth" görüldüyse preposition alanına tam olarak "on sb/sth" yaz, sadece "on" yazma.
   - Bir fiilin/sıfatın birden fazla edat kalıbı varsa (örn. "provide sb with sth", "talk to sb about sth") HEPSİNİ kaçırmadan yaz, virgülle ayırarak listele. Örnek: "to sb, about sth".
